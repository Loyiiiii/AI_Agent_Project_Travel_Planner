      ...
      {currentStep === "HERO" && (
        <section className="hero-section">
          ...
          <div className="hero-content">
            <p className="hero-eyebrow">Travel Planner Agent</p>
            <h1 className="hero-title">Where do you<br />want to <em>go?</em></h1>
            <p className="hero-sub">Tell us about your trip and our AI agents will craft the perfect itinerary for you.</p>
            <button type="button" className="btn-hero" onClick={() => setCurrentStep("FORM")}>
              Start Planning →
            </button>
          </div>
        </section>
